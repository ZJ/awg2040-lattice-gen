...
MACRO(BISONCPP_TARGET Name BisonInput BisonOutput)
	...
	ELSE()
		...
		ADD_CUSTOM_COMMAND(OUTPUT ${BISONCPP_TARGET_outputs}
			...
			ARGS ${BISONCPP_TARGET_cmdopt} --target-directory="${CMAKE_CURRENT_BINARY_DIR}" -p ${ARGV2} ${ARGV1}
		...
		SET(BISONCPP_${Name}_OUTPUTS "${CMAKE_CURRENT_BINARY_DIR}/${BISONCPP_TARGET_outputs}")
