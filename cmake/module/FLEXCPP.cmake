...
MACRO(FLEXCPP_TARGET Name Input Output)
	...
	ELSE()
		...
		IF(FLEXCPP_IMPLEMENTATION_HEADERS)
			...
			LIST(APPEND FLEXCPP_TARGET_extradeps ${FLEXCPP_IMPLEMENTATION_HEADERS}.h ${FLEXCPP_IMPLEMENTATION_HEADERS}.ih)
		ENDIF()
		...
		IF(FLEXCPP_IMPLEMENTATION_SKELETON)
			LIST(APPEND FLEXCPP_EXECUTABLE_opts --implementation-skeleton="${FLEXCPP_IMPLEMENTATION_SKELETON}")
			LIST(APPEND FLEXCPP_TARGET_extradeps ${FLEXCPP_IMPLEMENTATION_SKELETON})
			STRING(REGEX REPLACE "\\.skel$" "" FLEXCPP_TARGET_implementation "${FLEXCPP_IMPLEMENTATION_SKELETON}")
			LIST(APPEND FLEXCPP_TARGET_extraoutputs "${FLEXCPP_TARGET_implementation}")
		ENDIF()
		...
		ADD_CUSTOM_COMMAND(OUTPUT ${Output} ${FLEXCPP_TARGET_extraoutputs}
			...
			ARGS ${FLEXCPP_EXECUTABLE_opts} --target-directory="${CMAKE_CURRENT_BINARY_DIR}" -l ${Output} ${Input}
